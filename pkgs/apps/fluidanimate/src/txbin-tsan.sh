...
TXBIN_LD_LIBRARY=
TXBIN_LIBS="$LLVM_HOME/lib/libTxHooks.a $LLVM_HOME/lib/libtsan_rtl.a $LLVM_HOME/lib/libtsan_icp.a $LLVM_HOME/lib/libtsan_san.a $LLVM_HOME/lib/liblbr.a  -ldl -lpthread"
#TXBIN_LIBS="$LLVM_HOME/lib/libTxHooks.a $LLVM_HOME/lib/libdonot-rt.a -ldl -lpthread"
