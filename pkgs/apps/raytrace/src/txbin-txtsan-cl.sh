...
TXBIN_LIBS="-lm
	...
	-ldl
	-lpthread
	-lglut -lGLU -lGL -lGL -lGLU -lXmu -lXext -lXau -lX11"
...
TXBIN_OPT_CMD="${LLVM_OPT} ${TXBIN_LLVM_LIBS} -musthook musthook.txt -tx-instrument -log ${TXBIN_APP}.prof.out -tx-tsan -ulc -ltf ltrd.txt -o  ${TXBIN_OUTPUT_BC} ${TXBIN_INPUT_BC}"
