...
TXBIN_OPT_CMD="${LLVM_OPT} ${TXBIN_LLVM_LIBS} -tx-instrument -log ${TXBIN_APP}.prof.out -musthook musthook.txt -tx-tsan  -std-compile-opts -std-link-opts -o ${TXBIN_OUTPUT_BC} ${TXBIN_INPUT_BC}"
