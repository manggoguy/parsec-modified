...
TXBIN_OPT_CMD="${LLVM_OPT} ${TXBIN_LLVM_LIBS} -musthook musthook.txt -tx-instrument -log ${TXBIN_APP}.prof.out -ulc -ltf ltrd.txt -tx-tsan -o ${TXBIN_OUTPUT_BC} ${TXBIN_INPUT_BC}"
