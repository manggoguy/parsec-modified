...
CXXFLAGS=" -Ofast -g -funroll-loops -fprefetch-loop-arrays -fpermissive -fno-exceptions -static-libgcc -Wl,--hash-style=both,--as-needed -DPARSEC_VERSION=3.0-beta-20130728 -fexceptions" \
CFLAGS="$CXXFLAGS" \
LDFLAGS="-lpthread -Ofast -g" \
LIBS="-lstdc++" \
...
cp tools/iofuncs/vips ./vips.orig.exe
