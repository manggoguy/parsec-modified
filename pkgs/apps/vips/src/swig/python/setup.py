...
configure_flags = '-DG_DISABLE_CAST_CHECKS -pthread -I/usr/lib64/glib-2.0/include -I/usr/include/libxml2 -I/usr/include/glib-2.0            -lgthread-2.0 -pthread -lglib-2.0  -Wl,--export-dynamic -lgmodule-2.0 -pthread -lxml2 -lgobject-2.0 -lglib-2.0          -lm -I../../libvips/include -I../../libvipsCC/include'
...
def make_extension (name, source):
	return Extension (name, 
					 ...
					 runtime_library_dirs= ['/home/lzto/benchmark/parsec-3.0/pkgs/apps/vips/inst/amd64-linux.gcc-pthreads/lib'])
