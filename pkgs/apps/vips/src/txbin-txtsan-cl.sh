...
TXBIN_LD_LIBRARY=
TXBIN_LIBS="-lm -lpthread $LLVM_HOME/lib/libTxHooks.a -ldl -lxml2 -lgthread-2.0 -lgmodule-2.0 -lxml2 -lgobject-2.0 -lglib-2.0 -lpthread -lm -lstdc++ -pthread
$LLVM_HOME/lib/libtsan_rtl.a $LLVM_HOME/lib/libtsan_icp.a $LLVM_HOME/lib/libtsan_san.a
-lrt  -ldl -lpthread"
...
TXBIN_OPT_CMD="${LLVM_OPT} ${TXBIN_LLVM_LIBS} -tx-instrument  -musthook musthook.txt -log ${TXBIN_APP}.prof.out -ulc -tx-tsan -ltf ltrd.txt  -o ${TXBIN_OUTPUT_BC} ${TXBIN_INPUT_BC}"
