...
TXBIN_LD_LIBRARY=
TXBIN_LIBS="-lm -lpthread $LLVM_HOME/lib/libprof-rt.a $LLVM_HOME/lib/libdonot-rt.a libx264.a -ldl -lpthread"

# OUTPUT: BC FILE NAME
TXBIN_OUTPUT_BC=${TXBIN_APP}.prof.bc
TXBIN_OUTPUT_LL=${TXBIN_APP}.prof.ll
TXBIN_OUTPUT_EXE=${TXBIN_APP}.prof.exe
...
TXBIN_OPT_CMD="${LLVM_OPT} ${TXBIN_LLVM_LIBS} -tx-instrument -profile -musthook musthook.txt -o ${TXBIN_OUTPUT_BC} ${TXBIN_INPUT_BC}"
