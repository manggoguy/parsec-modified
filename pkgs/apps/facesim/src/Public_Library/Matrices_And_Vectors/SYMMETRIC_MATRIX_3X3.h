...
public:
	...
	//void Fast_Solve_Eigenproblem (DIAGONAL_MATRIX_3X3<double>& eigenvalues, MATRIX_3X3<double>& eigenvectors) const
	{
		//DIAGONAL_MATRIX_3X3<double> eigenvalues_double;
		//MATRIX_3X3<double> eigenvectors_double;
		DIAGONAL_MATRIX_3X3<T> eigenvalues_double;
		MATRIX_3X3<T> eigenvectors_double;
...
//#####################################################################
	...
	void Fast_Solve_Eigenproblem_Double (DIAGONAL_MATRIX_3X3<T>& eigenvalues, MATRIX_3X3<T>& eigenvectors, const double tolerance = 1e-7) const;
	void Fast_Eigenvectors_Double (const DIAGONAL_MATRIX_3X3<T>& eigenvalues, MATRIX_3X3<T>& eigenvectors, const double tolerance = 1e-7) const;
