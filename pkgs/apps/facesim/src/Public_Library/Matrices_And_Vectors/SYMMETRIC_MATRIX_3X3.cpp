...
Fast_Eigenvectors_Double (const DIAGONAL_MATRIX_3X3<T>& lambda, MATRIX_3X3<T>& eigenvectors, const double tolerance) const
{
...
//#####################################################################
template<class T> void SYMMETRIC_MATRIX_3X3<T>::
Fast_Solve_Eigenproblem_Double (DIAGONAL_MATRIX_3X3<T>& eigenvalues, MATRIX_3X3<T>& eigenvectors, const double tolerance) const
{
